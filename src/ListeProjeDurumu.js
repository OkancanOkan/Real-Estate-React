...
function ListeProjeDurumu()
{
    ...
    useEffect(
        async()=>
        {
            const response = await axios.get('https://private-610f9b-fullapi3.apiary-mock.com/getProjectStatusList');
            console.log(response);
            setProjectStatusName(response.data[0].ProjectStatusTable);
        },
        []
    );
                                ...
                                <div className="portlet-body">
                                    <div className="table-scrollable">
                                        <table className="table table-striped table-bordered table-advance table-hover">
                                            <tbody>
                                                {
                                                        ProjectStatusName.map((myArrayItem,index)=>
                                                        (
                                                ...
                                                <tr key={index}>
                                                    <td style={{ width: '30%' }} className="highlight">
                                                        ...
                                                        <a href="javascript:;">
                                                            {myArrayItem.ProjectStatusName} </a>
                                                    </td>
                                                    <td>
