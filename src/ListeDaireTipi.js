...
function ListeDaireTipi()
{
    const[FlatTypeName,setFlatTypeName]=useState([]);
        useEffect(
            async ()=>
            {
                const response = await axios.get ('https://private-610f9b-fullapi3.apiary-mock.com/getFlatTypeList');
                console.log(response);
                setFlatTypeName(response.data[0].FlatType);
                                ...
                                <div className="portlet-body">
                                    <div className="table-scrollable">
                                        <table className="table table-striped table-bordered table-advance table-hover">
                                            <tbody>
                                                {
                                                    FlatTypeName.map((myArrayItem,index)=>
                                                    (
