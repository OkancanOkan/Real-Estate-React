...
function FormCalisan() {
  const [txtEmployeeName, setTxtEmployeeName] = useState();
  const [txtEmployeeSurname, setTxtEmployeeSurname] = useState();
  ...
  const gonder = async () => {
    let requestBody = {
      ...
      EmployeeSurname: txtEmployeeSurname,
      Username: txtUsername,
      Password: txtPassword,
    };
    const response = await axios.post(
      "https://private-3fc19-insaatapi1.apiary-mock.com/postEmployee",
      requestBody
    );
    if (response.data.Result === "Yeni kullanıcı girişi başarılı.") {
      window.alert("OK");
                      ...
                      <div className="form-body">
                        ...
                        <div className="form-group">
                          ...
                          <input
                            ...
                            autoComplete="off"
                            onChange={(e) =>
                              setTxtEmployeeSurname(e.target.value)
                            }
                            required
                          />
                        </div>
