...
function ListeSehir()
{
    ...
    useEffect(
        async() => 
        {
            const response =await axios.get('https://private-610f9b-fullapi3.apiary-mock.com/getCityList');
            console.log(response);
            setCityName(response.data[0].CityTable);
        },
        []
            ...
            <div className="page-content">
                <div className="container">
                    ...
                    <ul className="page-breadcrumb breadcrumb">
                        <li>
                            <a href="#">İçerik Yönetimi</a><i className="fa fa-circle" />
                        </li>
                        <li>
                            ...
                            <div className="portlet light">
                                <div className="portlet-title">
                                    <div className="caption">
                                        ...
                                        <span className="caption-subject font-green-sharp bold uppercase">ŞEHİR</span>
                                    </div>
                                    <div className="tools">
                                ...
                                <div className="portlet-body">
                                    <div className="table-scrollable">
                                        <table className="table table-striped table-bordered table-advance table-hover">
                                            <tbody>
                                                {
                                                    CityName.map((myArrayItem,index)=>
                                                    (
                                                ...
                                                <tr key={index}>
                                                    <td className="highlight">
                                                        ...
                                                        <a href="javascript:;">
                                                            {myArrayItem.CityName} </a>
                                                    </td>
                                                    <td>
                                                        <a href="javascript:;" className="btn default btn-xs purple">
                                                            <i className="fa fa-edit" /> GÜNCELLE </a>
                                                        <a href="javascript:;" className="btn default btn-xs black">
                                                            <i className="fa fa-trash-o" /> SİL </a>
                                                    </td>
                                                </tr>
                                                 )
                                                 )
                                                ...
                                                <tr>
                                                    <td colSpan={2} align="center">
                                                        <a href="javascript:;" className="btn default btn-xs green">
                                                            <i className="fa fa-edit" /> Ekle </a>
                                                    </td>
                                                </tr>
