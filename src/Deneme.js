                                    ...
                                    <form role="form">
                                        <div className="form-body">
                                            <div className="form-group">
                                                ...
                                                <input type="text" className="form-control" placeholder="Projenin Adı" name="txtName" id="txtName" required />
                                            </div>
                                            <div className="form-group">
                                                <label>Şehir</label>
                                                <GetSehirCombo/>
                                        ...
                                        <div className="form-actions right">
                                            <button type="button" className="btn default" name="btnCancel" id="btnCancel">Vazgeç</button>
                                            <button type="submit" className="btn green" name="btnSubmit" id="btnSubmit">Kaydet</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
